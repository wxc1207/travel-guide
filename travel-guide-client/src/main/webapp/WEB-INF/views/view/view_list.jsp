    ...
    <div id="view-list-body">
        <div class="view-list-body-left">
            ...
            <div class="view-list-body-left-bottom" id="viewItem" lay-filter="viewItem">
                ...
                <c:forEach items="${viewVOPageInfo.list}" var="viewVO">
                    <div class="view-list-body-left-bottom-item">
                        <div class="view-list-body-left-bottom-item-left">
                            <div class="img-wrapper" style="width: 150px;height: 90px">
                                <img src="${viewVO.mainImage}" alt="" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="view-list-body-left-bottom-item-right">

                            <h1>景点 -
                                <a href="${pageContext.request.contextPath}/view/viewDetail?id=${viewVO.id}">${viewVO.name}</a>
                                <c:if test="${viewVO.englishName != null && viewVO.englishName != ''}">
                                    （${viewVO.englishName}）
                                </c:if>
                            </h1>
                            <span>天津</span>
                            <span class="layui-icon layui-icon-fire">${viewVO.watchCount}</span>
                            <span class="layui-icon layui-icon-praise">${viewVO.praiseCount}</span>
                        </div>
                    </div>
                </c:forEach>
                ...
                <nav>
                    <ul class="pagination">
                        ...
                        <c:if test="${viewVOPageInfo.hasPreviousPage}">
                            <li class="page-item">
                                <a class="page-link"
                                   href="${pageContext.request.contextPath}/view/listView?pageNum=${viewVOPageInfo.prePage}&pageSize=5"
                        ...
                        <c:forEach items="${viewVOPageInfo.navigatepageNums}" var="num">
                            <c:if test="${num == viewVOPageInfo.pageNum}">
                                <li class="page-item active"><a class="page-link" href="javascript:;">${num}</a></li>
                            </c:if>
                            <c:if test="${!(num == viewVOPageInfo.pageNum)}">
                                <li class="page-item"><a class="page-link"
                                                         href="${pageContext.request.contextPath}/view/listView?pageNum=${num}&pageSize=5">${num}</a>
                                </li>
                            </c:if>
                        </c:forEach>
