...
<script>
    layui.config({
        ...
        table.render({
            ...
            elem: '#question-list',
            toolbar: 'default',
            url: '${pageContext.request.contextPath}/question/listQuestionByUserId?userId=${userId}',
            count: 3,
            width: '100%',
            request: {
            ...
            cols: [[
                ...
                {field: 'createTime', title: '提问日期', width: 200},
        ...
        table.on('toolbar(question-list)', function (obj) {
            ...
            if (obj.event == 'delete') {
                ...
                layer.confirm('确定要删除吗？', {
                    ...
                    layui.$.ajax({
                        type: 'get',
                        url: '${pageContext.request.contextPath}/question/deleteQuestion?id=' + data[0].id,
