...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">添加游记</div>
            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" autocomplete="off" placeholder="请输入游记标题"
                ...
                <%--                    <div class="layui-input-block">--%>
                <%--                        <input type="text" name="startTime" autocomplete="off" placeholder="请输入交通路线"--%>
                <%--                               class="layui-input" lay-verify="required">--%>
                <%--                    </div>--%>
                <%--                </div>--%>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="startDay" autocomplete="off" placeholder="请输入游记的天数"
                               class="layui-input" lay-verify="required">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="startNumber" autocomplete="off" placeholder="请输入游记的天数"
                               class="layui-input" lay-verify="required">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="averageCost" autocomplete="off" placeholder="请输入人均消费"
                               class="layui-input" lay-verify="required">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">需用时长</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="xiaobiaoti" autocomplete="off" placeholder="请输入小标题"
                               class="layui-input" lay-verify="required">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        var xiaobiaoti = new E('#xiaobiaoti');
        //自己定义上传的方法
        ...
        form.on('submit(view-submit)', function (data) {
            ...
            //拿到完整的信息,将其提交到后台即可
            $.ajax({
                url: '${pageContext.request.contextPath}/travel/travelAdd',
                type: 'post',
                ...
                success: function (res) {
                    console.log(res);
                    var url = '${pageContext.request.contextPath}/user/travelList?userId=${user.id}';
                    var tit = '商品列表';
                    if (res.code == 0) {
                        //
