...
<script>
    layui.config({
        ...
        table.render({
            ...
            elem: '#question-list',
            toolbar: 'default',
            url: '${pageContext.request.contextPath}/comment/listCommentByUserId?userId=${userId}',
            count: 3,
            width: '100%',
            request: {
            ...
            cols: [[
                {type: 'checkbox'},
                {field: 'comment', title: '我的回答', width: 300},
        ...
        table.on('toolbar(question-list)', function (obj) {
            ...
            console.log(data);
            if (obj.event == 'add') {
                <%--location.href = '${pageContext.request.contextPath}/comment/commentAddView';--%>
                layer.open({
                    title: '提示',
            ...
            if (obj.event == 'delete') {
                ...
                layer.confirm('确定要删除吗？', {
                    ...
                    layui.$.ajax({
                        type: 'get',
                        url: '${pageContext.request.contextPath}/comment/deleteComment?id=' + data[0].id,
