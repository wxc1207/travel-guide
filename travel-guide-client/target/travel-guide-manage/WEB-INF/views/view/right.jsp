...
<div class="view-list-body-right">
    ...
    <div class="view-list-body-right-top">
        <h2>浏览量景点排行</h2>
        <!--                一个景点 -->
        <c:forEach items="${watchViewList}" var="watchView" varStatus="i">
            <div class="view-list-body-right-top-item">
                ...
                <p style="display: inline-block;margin-left: 10px;font-size: 13px">天津-
                    <a href="${pageContext.request.contextPath}/view/viewDetail?id=${watchView.id}">${watchView.name}</a>
                </p>
                    <%--                点赞量 就不要 浏览量了--%>
    ...
    <div class="view-list-body-right-bottom">
        <h2>点赞量量景点排行</h2>
        <c:forEach items="${praiseViewList}" var="praiseView" varStatus="i">
            <div class="view-list-body-right-top-item">
                <c:if test="${i.index + 1 == 1}">
                    <button class="layui-btn layui-btn-xs layui-btn-danger" style="display: inline-block">
                            ${i.index + 1}
                ...
                <p style="display: inline-block;margin-left: 10px;font-size: 13px">天津-
                    <a href="${pageContext.request.contextPath}/view/viewDetail?id=${praiseView.id}">${praiseView.name}</a></p>
                <span class="layui-icon layui-icon-praise"
                      style="display: inline-block;margin-left: 20px;font-size: 13px">${praiseView.praiseCount}</span>
                    <%--            <span class="layui-icon layui-icon-praise"--%>
