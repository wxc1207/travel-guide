...
<head>
    <meta charset="utf-8">
    <title>${questionVO.question}</title>
...
<div id="view">
    ...
    <div class="view-body">
        <div class="view-body-banner">
            <div class="view-body-subtitle">
                ...
                <div class="comment">
                    <h1>旅友回答：</h1><br>
                    <c:if test="${questionCommentVOList != null}">
                        <div class="in-border">
                            <c:forEach items="${questionCommentVOList}" var="questionCommentVO">
                                <div class="in-border-item">
                                    <div class="in-border-left">
                                        <img src="${questionCommentVO.headImage}" alt="" width="80px" height="80px">
                                        <h1>${questionCommentVO.nickname}</h1>
                                    </div>
                                    <div class="in-border-right">
                                        <div class="in-border-right-top">
                                            <p>发表于${questionCommentVO.createTime}</p>
                                        </div>
                                        <div class="in-border-right-bottom">
                                            <p>
                                                    ${questionCommentVO.comment}<br>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
                            <c:if test="${questionCommentVOList[0] == null || questionCommentVOList[0] == ''}">
                                暂无评论
                            </c:if>
                            ...
                            <form id="commentFrom">
                                ...
                                <input type="text" style="display:none" id="viewId" name="questionId" value="${questionVO.id}">
    ...
    <script type="text/javascript">
        ...
        function submitFrom() {
            ...
            dataForm.questionId = $('#questionId').val();
            console.log(dataForm);
            $.ajax({
                type: "post",// 请求方式
                url: "${pageContext.request.contextPath}/comment/addQuestionComment",// 发送请求地址
                ...
                success: function (data) {
                    ...
                    if (data.code == 0) {
                        alert("成功了");
                        location.href = '${pageContext.request.contextPath}/question/questionDetail' + data.data;
                    }
                }
