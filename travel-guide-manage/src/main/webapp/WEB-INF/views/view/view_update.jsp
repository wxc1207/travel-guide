            ...
            <form class="layui-form" action="" lay-filter="component-form-group">
                ...
                <div class="layui-form-item">
                            ...
                            <select name="categoryId" lay-verify="required">
                                ...
                                <optgroup label="请选择类别">
                                    <c:forEach items="${categoryList}" var="child">
                                        <c:if test="${child.id == view.categoryId}">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="name" autocomplete="off" placeholder="请输入景点名称"
                                   class="layui-input" lay-verify="required" value="${view.name}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="englishName" autocomplete="off" placeholder="请输入景点英文名称"
                                   class="layui-input" value="${view.englishName}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="subtitle" autocomplete="off" placeholder="请输入简介"
                                   class="layui-input" lay-verify="required" value="${view.subtitle}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <div class="layui-upload-list">
                                <img class="layui-upload-img" id="mainImagePreview" src="${view.mainImage}">
                                <p id="demoText"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                预览图：
                                <div class="layui-upload-list" id="subImagesPreview">
                                    <c:forEach items="${subImages}" var="subImage">
                                        <img src=" ${subImage}" alt="" class="layui-upload-img old">
                                    </c:forEach>
                                </div>
                            </blockquote>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="traffic" autocomplete="off" placeholder="请输入交通路线"
                                   class="layui-input" lay-verify="required" value="${view.traffic}">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="ticket" autocomplete="off" placeholder="请输入票价"
                                   class="layui-input" lay-verify="required" value="${view.ticket}">
                        </div>
                    </div>
                    ...
                    <div class=" layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" maxlength="" name="phone" autocomplete="off" placeholder="请输入手机号"
                                       class="layui-input" lay-verify="required|checkPhone" value="${view.phone}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="needTime" autocomplete="off" placeholder="请输入需用时间"
                                       class="layui-input" lay-verify="required" value="${view.needTime}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="openingHours" autocomplete="off" placeholder="请输入开放时间"
                                       class="layui-input" lay-verify="required" value="${view.openingHours}">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="address" autocomplete="off" placeholder="请输入地址"
                                       class="layui-input" lay-verify="required" value="${view.address}">
                            </div>
                        </div>
...
<script>
    layui.config({
        ...
        //官网上示例的写在<script>标签内部，但是我们使用了LayUI框架，默认也会加载layui.use的内容，所以我们也可以写在这里
        ...
        <%--//设置上传图片http请求参数名，--%>
        <%--//出现了问题，当选择一张图片时，名字为file;当选择多张图片时，名字为file1,file2,file3--%>
        <%--//解决办法，那就限制多图上传了，--%>
        <%--editor.config.uploadFileName = 'file';--%>
        <%--// 一次最多上传图片的数量--%>
        <%--editor.config.uploadImgMaxLength = 10;--%>
        <%--editor.config.placeholder = '亲，请记得编辑你的详情哦';--%>
        <%--//-------------------------------------------%>
        ...
        form.on('submit(view-submit)', function (data) {
            ...
            //拿到完整的信息,将其提交到后台即可
            $.ajax({
                url: '${pageContext.request.contextPath}/view/viewUpdate',
                type: 'post',
